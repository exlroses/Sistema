...
switch ($_GET['op'])
{
    case 'guardaryeditar':
        ...
        if (empty($idusuario))
        {
            $rspta = $usuario->ingresar($nombre,$tipo_documento,$num_documento,$direccion,$telefono,$email,$cargo,$login,$clavehash,$imagen,$_POST["permiso"]);
            echo $rspta?"se ha ingresado datos": "No se pudieron registrar todos los datos del usuario";
        }else
        {
    ...
    case 'permisos':
        ...
        //Declaramos el aray para almacenar  todos los permisos marcados
        $valores = array();
    ...
    case 'verificar':
        ...
        if (isset($fetch))
        {
            ...
            //Obtenemos los permisos del usuaior

            $marcados = $usuario->listarMarcados($fetch->idusuario);

            // Declamaron un array para recorrer todos los permisos marcados
